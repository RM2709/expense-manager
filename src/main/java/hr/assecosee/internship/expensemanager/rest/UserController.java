...
public class UserController {
     ...
     * @return JSON object containing a Status code, a message describing the outcome of the operation, and basic information of the retrieved user (id, full name, first name, last name, email, budget, budget days).
     */
    ...
    @Operation(summary = "Retrieve an user.",
            description = "Retrieves an existing user from the database. Response contains a status code, a message describing the outcome of the operation " +
                    "and the retrieved user's data (id, name, email, budget).")
     ...
     * @return Status code, a message describing the outcome of the operation, and basic information of the created user (id, full name, first name, last name, email, budget, budget days).
     */
    @PostMapping("")
    @Operation(summary = "Create a new user.",
            description = "Creates a new user and inserts it into the database. Response contains a status code, a message describing the outcome of the operation " +
                    "and the newly created user's data (id, name, email, budget).")
     ...
     * @return Status code, a message describing the outcome of the operation, and basic information of the updated user (id, full name, first name, last name, email, budget, budget days).
     */
    ...
    @Operation(summary = "Update an existing user.",
            description = "Updates an existing user in the database. Response contains a status code, a message describing the outcome of the operation " +
                    "and the updated user's data (id, name, email, budget).")
